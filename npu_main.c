 ...
 *
 * The grant status at HW_MUTEX_STATUS is not read back. No caller uses the
 * result, and on AN7583 the first read of the block never returns: core 0
 * freezes on that load with the acquire write already retired. */
